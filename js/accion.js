...
btn.addEventListener('click', function(){
	...
	tabla.insertRow(-1).innerHTML = '<td></td><td>'+nom+'</td><td>'+tel+'</td><td>'+dir+'</td><td><button class="btn btn-info mr-1" data-toggle="modal" data-target="#registro" onclick="nuevaFila();"><i class="far fa-file text-light"></i></button><button class="btn btn-warning mr-1" data-toggle="modal" data-target="#registro" onclick="modificarFila(this);"><i class="far fa-edit text-light"></i></button><button class="btn btn-danger"><i class="fa fa-trash text-light"></i></button></td>';
});
